...
namespace nc
{
	...
	const int Data::kJulianDayOf1970_01_01 = detail::getJulianDayNumber(1970, 1, 1);
}
...
Date::Date(const struct& tm& t):
	julianDayNumber_(getJulianDayNumber(t.tm_year + 1900, t.tm_mon + 1, t.tm_day))
{}
...
string Date::toIsoString() const
{
	...
	snprintf(buf, sizeof buf, "%4d-%02d-%02d", ymd.yead, ymd.month, ymd.day);
